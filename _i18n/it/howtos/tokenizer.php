...
<p><strong>Versioni per Windows di OmegaT</strong>: per usare il tokenizer con OmegaT (qualsiasi versione) occorre un apposito file script di avvio. Tale file script di avvio non viene fornito con le versioni di OmegaT per Windows. Se si utilizza la versione di Windows con JRE, scaricare il file <a href="/files/OmegaT_with_JRE.bat">OmegaT_with_JRE.bat</a>; per la versione di Windows senza JRE, scaricare invece il file <a href="/files/OmegaT_without_JRE.bat">OmegaT_without_JRE.bat</a>. Dopo lo scaricamento, inserire il file nella cartella principale di OmegaT (la cartella contenente il file OmegaT.jar, per esempio C:\Programmi\OmegaT).</p>
