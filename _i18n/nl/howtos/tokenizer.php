...
<p><strong>Windows-versies van OmegaT</strong>: om OmegaT (elke versie) te kunnen laten werken met de Tokenizer, moet die worden gestart vanuit een opstartbestand. Een bestand voor opstarten wordt niet meegeleverd met de versies van OmegaT voor Windows. Indien u de versie van Windows met JRE gebruikt, download het bestand <a href="/files/OmegaT_with_JRE.bat">OmegaT_with_JRE.bat</a>; Indien u de versie van Windows zonder JRE gebruikt, download dan het bestand <a href="/files/OmegaT_without_JRE.bat">OmegaT_without_JRE.bat</a>. Plaats, na het downloaden, het bestand in de hoofdmap van OmegaT (de map die het bestand OmegaT.jar bevat).</p>
