...
<p><strong>Versi&oacute;ns de Windows de OmegaT</strong>: para poder empregar o tokenizer en OmegaT, ser&aacute; necesario que o execute dende un ficheiro de script de inicio. Non se incl&uacute;e este ficheiro nas versi&oacute;ns de OmegaT de Windows. Se est&aacute; usando a versi&oacute;n de Windows con JRE, descargue o ficheiro <a href="/files/OmegaT_with_JRE.bat">OmegaT_with_JRE.bat</a>; pola contra, se est&aacute; empregando a versi&oacute;n de Windows sen JRE, descargue o ficheiro <a href="/files/OmegaT_without_JRE.bat">OmegaT_without_JRE.bat</a>. Unha vez finalice a descarga, sit&uacute;e o arquivo no cartafol principal de OmegaT (o cartafol no que se atopa o ficheiro OmegaT.jar).</p>
